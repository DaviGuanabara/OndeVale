...
FOLD_METRICS_PATH = VALIDATION_DIR / "fold_metrics.csv"
VALIDATION_SUMMARY_PATH = VALIDATION_DIR / "validation_summary.csv"
VALIDATION_METADATA_PATH = VALIDATION_DIR / "validation_metadata.json"
MAE_BOXPLOT_PATH = VALIDATION_DIR / "mae_boxplot.png"
RMSE_BOXPLOT_PATH = VALIDATION_DIR / "rmse_boxplot.png"
R2_BOXPLOT_PATH = VALIDATION_DIR / "r2_boxplot.png"
SELECTED_VS_TRIVIAL_DISTRIBUTION_PATH = VALIDATION_DIR / "selected_vs_trivial_distributions.png"
